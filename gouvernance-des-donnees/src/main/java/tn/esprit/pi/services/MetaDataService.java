...
import tn.esprit.pi.client.ColumnClient;
...
import tn.esprit.pi.repositories.FileMetadataRepo;
...
public class MetaDataService {
    ...
    public List<Column> getColumns() {
        ...
        List<Column> columns = client.getAllColumns();
        return columns;
    }
