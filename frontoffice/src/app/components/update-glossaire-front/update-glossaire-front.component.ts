...
@Component({
  selector: 'app-update-glossaire-front',
  templateUrl: './update-glossaire-front.component.html',
  styleUrls: ['./update-glossaire-front.component.css']
})
export class UpdateGlossaireFrontComponent {
