...
@Component({
  selector: 'app-update-feedback-front',
  templateUrl: './update-feedback-front.component.html',
  styleUrls: ['./update-feedback-front.component.css']
})
export class UpdateFeedbackFrontComponent {
